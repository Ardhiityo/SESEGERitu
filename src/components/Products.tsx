  ...
  const products = [
    {
      ...
      title: "Hibiscus",
      description: "Ekstrak Bunga Rosela & Serai.",
    ...
    },
    {
      ...
      title: "Summer Time",
      description: "Ekstrak Lemon Serai Selasih.",
    ...
    },
    {
      ...
      title: "Tropical Blue",
      description: "Ekstrak Telang Jahe Serai.",
      benefit: "Antioksidan",
      price: "15.000",
    },
    {
      ...
      description: "Ekstrak Lemon Wortel Chia Seed.",
